...
import { LogIn, GraduationCap, Users, Mail, AlertTriangle, Menu } from 'lucide-react'
  ...
  useEffect(() => {
    const fetchCovidUpdate = async () => {
      const response = await new Promise(resolve => 
        setTimeout(() => resolve("Campus is open with safety measures in place."), 1000)
      )
      ...
      <div className="relative z-10 flex flex-col items-center justify-between min-h-screen">
        ...
        <header className="w-full text-center pt-8">
          <div className="flex justify-center items-center space-x-4">
            ...
            <img src="public/placeholder.svg" alt="College Logo" className="w-15 h-15" />
            <div className="h-px bg-orange-500 w-20" />
          </div>
          <motion.h1
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button 
                    ...
                    size="icon" 
                    className="rounded-full bg-orange-100 hover:bg-orange-200"
                    onClick={() => handleNavigation('/undergraduate')}
                  >
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button 
                    ...
                    size="icon" 
                    className="rounded-full bg-orange-100 hover:bg-orange-200"
                    onClick={() => handleNavigation('/graduate')}
                  >
